...
public class Percolation {
	...
	/**
	 * Method called in open, unions specified
	 * cell with its neighbours, checks if it is full,
	 * if it is - fulls all the open neighbours, 
	 * checks if system percolates
	 * @param i - index of row of cell in grid
	 * @param j - index of column of cell in grid
	 */
	...
	/**
	 * Fulls all open neighbours of full cell
	 * @param i - index of row of cell in grid
	 * @param j - index of column of cell in grid
	 */
	...
	/**
	 * Open specified cell
	 * @param row - index of row of cell in grid
	 * @param col - index of column of cell in grid
	 */
	...
	/**
     * Check if parameters are validate
     * @param row - index of row of cell in grid
     * @param col - index of column of cell in grid
	 */
