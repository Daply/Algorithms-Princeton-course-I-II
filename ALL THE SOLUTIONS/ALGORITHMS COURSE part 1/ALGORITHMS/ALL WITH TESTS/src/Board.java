...
public class Board {
    ...
    public Board(int[][] blocks) {
        ...
        int[] inversBlocks = new int [this.n*this.n];
        int ind = 0;
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                ...
                inversBlocks[ind] = this.blocks[i][j];
                ind++;
            }
        }
        ...
        if ((this.n % 2 != 0 && countInversions % 2 == 0) ||
                (this.n % 2 == 0 && countInversions % 2 != 0 &&
                (this.n - this.emptyBJ) % 2 == 0) ||
                (this.n % 2 == 0 && countInversions % 2 == 0 &&
                (this.n - this.emptyBJ) % 2 != 0)) {
